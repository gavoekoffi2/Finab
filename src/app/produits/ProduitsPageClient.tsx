            ...
            {productsCanada.map((product, i) => (
              ...
              >
                <div className={i % 2 === 1 ? "md:order-2" : ""}>
                  <h3 className="text-2xl md:text-3xl font-bold text-dark mb-4">{product.title}</h3>
                ...
                <div className={`bg-gradient-to-br from-primary/5 to-primary/5 rounded-3xl p-12 flex items-center justify-center ${i % 2 === 1 ? "md:order-1" : ""}`}>
