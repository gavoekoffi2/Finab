          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="bg-surface rounded-2xl p-6 border-l-4 border-primary">
                ...
                <p className="text-xl font-bold text-primary">{siteConfig.ceo}</p>
              </div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-primary/10 to-primary-light/10 rounded-3xl p-12 flex items-center justify-center"
            >
