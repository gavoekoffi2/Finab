          ...
          <AnimatePresence mode="wait">
            {!showResult ? (
              ...
              >
                ...
                <h3 className="text-xl md:text-2xl font-bold text-dark mb-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {quizQuestions[step].options.map((opt) => (
                    <motion.button
                      ...
                      className="p-4 rounded-xl bg-white border-2 border-transparent hover:border-primary text-left font-medium text-dark shadow-sm hover:shadow-md transition-all cursor-pointer"
                    >
                      {opt.label}
                    </motion.button>
                  ))}
              ...
              >
                ...
                <div className="bg-white/10 rounded-2xl p-6 mb-8">
                  <p className="text-xl font-bold text-primary-light">{getRecommendation().service}</p>
                </div>
